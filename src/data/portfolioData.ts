...
export const portfolioData = {
  ...
  experience: [
    {
      ...
      type: "Full Time",
      mode: "Onsite · Kediri",
      description: "Mengembangkan dan memelihara sistem informasi untuk manajemen pasar tradisional, termasuk sistem absensi, pembayaran digital, dan monitoring transaksi.",
    ...
    },
    {
      ...
      type: "Full Time",
      mode: "Onsite · Kediri",
      description: "Mengembangkan sistem ERP menggunakan Odoo, termasuk kustomisasi modul, integrasi dengan sistem lain, dan membuat modul baru.",
  ...
  projects: [
    ...
    {
      name: "Bot Telegram",
      description: "Aplikasi bot telegram yang digunakan untuk membantu produktivitas karyawan di PT Adaptiv. Bot ini terhubung dengan sistem Odoo untuk menyimpan data dan terhubung dengan gitlab untuk produktivitas dalam development karyawan.",
